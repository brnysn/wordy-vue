<template lang="pug">
Dialog.dialog.stats-dialog.child-mode-stats-dialog(
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const isGameOver = computed(() => store.getters['child/isGameOver'])

    const questions = computed(() => store.getters['child/questions'])
    ...
    const setAnswers = () => {
      correctAnswers.value = JSON.parse(window.localStorage.getItem('childCorrectAnswers')) || []
      wrongAnswers.value = JSON.parse(window.localStorage.getItem('childWrongAnswers')) || []
      passedAnswers.value = JSON.parse(window.localStorage.getItem('childPassedAnswers')) || []
    }
    ...
    const myAnswer = question => {
      const storedAnswers = JSON.parse(window.localStorage.getItem('childMyAnswers'))
...
<style lang="scss" src="./ChildModeStatsDialog.component.scss"></style>
